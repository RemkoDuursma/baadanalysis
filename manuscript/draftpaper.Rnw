...
<<results='asis'>>=
printit(tab_mlfastba, caption="Number of observations used in the analysis of Mf/As. Individual plants (number of species).")
@


<<results='asis'>>=
printit(tab_alfastba, caption="Number of observations used in the analysis of Af/As. Individual plants (number of species).")
@


<<results='asis'>>=
printit(tab_lmf, caption="Number of observations used in the analysis of leaf mass fraction (LMF). Individual plants (number of species).")
@


<<results='asis'>>=
printit(tab_lar, caption="Number of observations used in the analysis of leaf area ratio (LAR). Individual plants (number of species).")
@
