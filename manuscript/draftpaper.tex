...
\item There is no shortage of theoretical developments in understanding biomass allocation (WBE, \cite{franklin_modeling_2012}). In particular, theoretical work focusing on optimal partitioning theory is promising (e.g. \cite{valentine_modeling_2012}) but is yet to lead to operational models for dynamic global vegetation models.
