...
allombygroupandpftplot <- function(xvar, yvar, studyName, xlab=AxisLabels[[xvar]], 
  ...
  smfitsEA <- sma(Y ~ X*Group, data=subset(studyName,pft=="EA"), log='xy', n_min=n_min, quiet=TRUE)
  smfitsEG <- sma(Y ~ X*Group, data=subset(studyName,pft=="EG"), log='xy', n_min=n_min, quiet=TRUE)
  smfitsDA <- sma(Y ~ X*Group, data=subset(studyName,pft=="DA"), log='xy', n_min=n_min, quiet=TRUE)
